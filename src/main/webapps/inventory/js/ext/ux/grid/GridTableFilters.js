...
Ext.ux.grid.GridTableFilters = function(config){		
...
Ext.extend(Ext.ux.grid.GridTableFilters, Ext.util.Observable, {
	/**
	...
	onRender: function(){
		var hmenu = null;
        if (this.buttonMenu)
            hmenu = this.buttonMenu;
        else 
            hmenu = this.grid.getView().hmenu;
		
		//this.sep  = hmenu.addSeparator();
        var thetext = 'Filters';
        if (this.menuText) thetext = this.menuText;
	...
	onBeforeLoad: function(store, options){
        ...
        //    console.log("gtf %s=%s", p, options.params[p]);
        //}
	},
