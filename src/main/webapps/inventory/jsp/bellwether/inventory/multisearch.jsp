...
<div id="searchpanel">
    <form class="formular" action="inventory!multiSearch.bc" id="inventorysearchform" method="post">
        <table>
            <tr>
...
dataAction="inventory!multiSearchData.bc" table="${listTable}" addToContainer="listpanel" stateful="true"/>
