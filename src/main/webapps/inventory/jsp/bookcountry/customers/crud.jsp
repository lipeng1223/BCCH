            ...
            <td style="padding-left:15px;" valign="top">
                ...
                <table>
                    <tr>
                        ...
                        <td align="left" style="padding-left:10px;">
                        <select name="customer.emailInvoice"> 
                            <option value="false" <s:if test="!customer.emailInvoice">selected="selected"</s:if>>No</option>
                            <option value="true" <s:if test="customer.emailInvoice">selected="selected"</s:if>>Yes</option>
                        </select> 
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" style="padding-left:10px;">
                        <s:textfield key="customer.invoiceEmail" maxlength="128" id="customer.invoiceEmail" cssClass="text-input" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
