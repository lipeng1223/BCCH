...
Ext.onReady(function(){
    ...
    salesHistoryCustomerId = <s:property value="customer.id"/>;
...
<inv:table tableName="orders" sortable="true" exportable="true" tableTitle="Sales History"
dataAction="history!salesData.bc?id=${id}" table="${listTable}" addToContainer="listpanel" stateful="true"/>
