...
@Results({
    @Result(name="list", location="/WEB-INF/jsp/bellwether/vendors/list.jsp"),
    @Result(name="detail", location="/WEB-INF/jsp/bellwether/vendors/detail.jsp"),
    @Result(name="crud", location="/WEB-INF/jsp/bellwether/vendors/crud.jsp"),
...
public class VendorAction extends BaseAction {
    ...
    public String createSubmit(){
        try {
            BellVendorSessionLocal vendorSession = getBellVendorSession();
    ...
    public String editSubmit(){
        try {
            BellVendorSessionLocal vendorSession = getBellVendorSession();
            BellVendor dbv = vendorSession.findById(vendor.getId());
            ...
            BellVendorCache.remove(vendor.getId());
            BellVendorCache.put(vendorSession.findById(vendor.getId()));
            setSuccess(true);
