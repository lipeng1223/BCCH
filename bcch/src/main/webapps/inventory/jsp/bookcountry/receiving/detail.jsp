...
<div style="background:#fff;width:100%;height:100%">
    <div style="padding:8px;">
        <table>
            ...
            <tr>
                <td align="right" nowrap valign="top">Holding:</td>
                <td align="left" style="padding-left:5px;" class="bluetext" nowrap><s:if test="receiving.holding"><span class='greentext'>Yes</span></s:if><s:else><span class='redtext'>No</span></s:else></td>
            </tr>
            <tr><td><div style="height:4px;"></div></td></tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" style="padding-left:5px;" class="bluetext" nowrap><s:property value="receiving.publisher"/></td>
            </tr>
            <tr><td><div style="height:4px;"></div></td></tr>
            <tr>
            ...
            <tr><td><div style="height:4px;"></div></td></tr>
            <tr>
                <td align="right" nowrap valign="top">Skid Codition:</td>
                <td align="left" style="padding-left:5px;" class="bluetext" nowrap><s:property value="receiving.skidCondition"/></td>
            </tr>
            <tr><td><div style="height:4px;"></div></td></tr>
            <tr>
