...
<div style="padding-left:15px;padding-top:15px;">
    <form action="orderitem!upload.bc" name="uploadform" id="uploadform"  method="POST" enctype="multipart/form-data">
        ...
        <tr><td align="right">Condition Col:</td><td align="left" style="padding-left:10px;"><s:textfield name="condCol" value="B" cssStyle="width:40px;"/></td></tr>
        <tr><td align="right">Quantity Col:</td><td align="left" style="padding-left:10px;"><s:textfield name="qtyCol" value="C" cssStyle="width:40px;"/></td></tr>
        <tr><td align="right">Selling Price Col:</td><td align="left" style="padding-left:10px;"><s:textfield name="priceCol" value="D" cssStyle="width:40px;"/></td></tr>
