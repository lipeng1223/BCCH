...
<s:set name="stateSession" value="%{'inventory-item-view-orders-state'}"/>
...
dataAction="inventoryitem!listOrders.bc?id=${inventoryItem.id}&showNewWindowButton=false" table="${orderListTable}" addToContainer="orderlistpanel" stateful="true"
