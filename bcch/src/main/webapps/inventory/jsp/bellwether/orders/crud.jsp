...
cslist['<s:property value="#cust.id"/>'][0] = new Array(<s:iterator value="#cust.bellCustomerShippings" var="cs" status="status"><s:if test="#status.index > 0">,</s:if>'<s:property value="escapeJavaScript(#cs.gridDisplay)"/>'</s:iterator>);
cslist['<s:property value="#cust.id"/>'][1] = new Array(<s:iterator value="#cust.bellCustomerShippings" var="cs" status="status"><s:if test="#status.index > 0">,</s:if>'<s:property value="#cs.id"/>'</s:iterator>);
...
customers.add(<s:property value="#cust.id"/>, "{display:[<s:iterator value="#cust.customerShippings" var="cs" status="status"><s:if test="#status.index > 0">,</s:if>'<s:property value="escapeJavaScript(#cs.gridDisplay)"/>'</s:iterator>], ids:[<s:iterator value="#cust.customerShippings" var="cs" status="status"><s:if test="#status.index > 0">,</s:if>'<s:property value="#cs.id"/>'</s:iterator>], sales:'<s:property value="#cust.salesRep"/>'}");
</s:iterator>
...
Ext.onReady(function(){
    ...
    <s:if test="order != null">
        customerChange(document.getElementById("customerId"));
...
function customerChange(box){
    ...
    if (json != undefined){
        ...
        document.getElementById("order.salesman").value = json.sales;
        fillList( box.form.customerShippingId, json.display, json.ids );
    }
}
...
function fillList( box, disp, ids ) {
...
<form action="order!createSubmit.bc" name="crudform" id="crudform" class="formular">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td align="left" style="padding-left:10px;">
                    <select name="customerShippingId" id="customerShippingId"></select>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td align="left" style="padding-left:10px;">
                    <s:textfield key="order.poNumber" maxlength="50" id="order.poNumber" cssClass="text-input" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <s:textfield key="order.salesman" maxlength="50" id="order.salesman" cssClass="text-input" />
                    </s:if><s:else>
                    <s:textfield key="order.salesman" maxlength="50" id="order.salesman" cssClass="text-input" readonly="true"/>
                    </s:else>
                    </td>
                </tr>
                <%--
                <tr>
                    ...
                    <td align="left" style="padding-left:10px;">
                    <s:textfield key="order.comment2" maxlength="255" id="order.comment2" cssClass="text-input" />
                    </td>
                </tr>
                --%>
                <tr>
                    ...
                    <td align="left" style="padding-left:10px;">
                    <s:textfield key="order.comment" maxlength="255" id="order.comment" cssClass="text-input" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td align="left" style="padding-left:10px;">
                    <s:textfield key="order.shipVia" maxlength="100" id="order.shipVia" cssClass="text-input" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td align="left" style="padding-left:10px;">
                    <s:textfield key="order.shippingCharges" maxlength="12" id="order.shippingCharges" cssClass="text-input" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td align="left" style="padding-left:10px;">
                    <s:textfield key="order.palleteCharge" maxlength="12" id="order.palleteCharge" cssClass="text-input" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td align="left" style="padding-left:10px;">
                    <s:textfield key="order.depositAmmount" maxlength="12" id="order.depositAmmount" cssClass="text-input" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    ...
                    <td align="left" style="padding-left:10px;">
                    <s:textfield key="order.picker1" maxlength="2" id="order.picker1" cssClass="text-input" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td align="left" style="padding-left:10px;">
                    <s:textfield key="order.picker2" maxlength="2" id="order.picker2" cssClass="text-input" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td align="left" style="padding-left:10px;">
                    <s:textfield key="order.qualityControl" maxlength="2" id="order.qualityControl" cssClass="text-input" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td align="left" style="padding-left:10px;">
                     <s:select name="order.status" list="#{'':'', 'Picking':'Picking', 'QC':'QC', 'Invoicing':'Invoicing', 'Processing':'Processing', 'Returned to Accounting':'Returned to Accounting', 'Holding for Payment':'Holding for Payment', 'Return to Stock':'Return to Stock', 'Routed':'Routed', 'Hold':'Hold', 'Printed':'Printed'}" id="order.status"/>
                    </td>
                </tr>
        </table>
