...
<s:set name="stateSession" value="%{'bellinventory-item-list-state'}"/>
...
<div id="searchpanel">
    <form class="formular" action="inventory!search.bc" id="inventorysearchform" method="post">
...
<inv:table tableName="bellinventory" sortable="true" exportable="true" tableTitle="Matching Inventory Items"
dataActionParams="${search.queryString}"
dataAction="inventory!searchData.bc" table="${listTable}" addToContainer="listpanel" stateful="true" rowDblClick="rowDoubleClick"/>
...
<script language="JavaScript" type="text/javascript">
    Ext.onReady(function(){
        ...
        Ext.grid.bellinventoryGrid.getSelectionModel().on("rowselect", function(model, idx, rec){
            curSelectedIdx = idx;
            curSelectedRec = rec;
        });
    });
