...
function createButtonClick(){
    ...
    Ext.crudWindow.show(Ext.grid.vendorsGrid);
}
function editButtonClick(){
    var selected = Ext.grid.vendorsGrid.getSelectionModel().getSelected();
    if (!selected){
        Ext.Msg.show({
            title:'Error',
...
function updateVendorDetail(force){
    var selections = Ext.grid.vendorsGrid.getSelectionModel().getSelections();
